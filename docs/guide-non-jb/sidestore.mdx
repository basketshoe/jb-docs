...
## Aggiungere app alla schermata home

1. Apri LiveContainer
2. Tieni premuto sull'app che vuoi aggiungere alla home
3. Clicca su "Aggiungi alla Home" e poi "Aggiungi App Clip"
4. Installa il profilo e vedrai l'app comparire nella home 

## Abilitare Modalità JIT

1. Installa [StikDebug](https://apps.apple.com/app/stikdebug/id6744045754) dall'App Store
2. Apri l'app e importa il pairing file (lo trovi in `Il mio iPhone/iPad` -> `SideStore` -> `ALTPairingFile.mobiledevicepairing`)
3. Ora chiudi e riapri StikDebug
4. Clicca "Connect By App" e seleziona un'app dalla lista per attivare JIT su quell'app

:::note
StikDebug funziona in modo simile a StosVPN, puoi quindi installare e refreshare le app di SideStore utilizzando StikDebug e disinstallando StosVPN
:::
